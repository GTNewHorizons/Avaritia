...
public class Tonkers {
    ...
    public static void buildstruct() {
        ...
        neutronium = new ToolMaterial(
                neutroniumName,
                "material." + neutroniumName,
                5,
                4800,
                900,
                8,
                ...
                0x303030);
        infinityMetal = new ToolMaterial(
                infinityMetalName,
                "material." + infinityMetalName,
                5,
                10000,
                6000,
                50,
                ...
                10,
                0.0f,
                LudicrousItems.cosmic.rarityColor.toString(),
                0xFFFFFF);
        ...
        pb.registerFullMaterial(
                ...
                2,
                neutroniumName,
                new ItemStack(TinkerTools.toolShard, 1, neutroniumId),
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.pickaxeHead, 1, infinityMetalId),
                "XXX  ",
                "  XX ",
                "   XX",
                "    X",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.shovelHead, 1, infinityMetalId),
                " XXX",
                "XXXX",
                "  XX",
                "  X ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.hatchetHead, 1, infinityMetalId),
                "  X  ",
                " XXX ",
                "XXXXX",
                "   X ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.binding, 1, infinityMetalId),
                "X X",
                " X ",
                "X X",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.toughBinding, 1, infinityMetalId),
                "X   X",
                " X X ",
                "  X  ",
                " X X ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.toughRod, 1, infinityMetalId),
                "        X",
                "       X ",
                "      X  ",
                "     X   ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.largePlate, 1, infinityMetalId),
                "XXXXX",
                "X X X",
                "XXXXX",
                "X   X",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.swordBlade, 1, infinityMetalId),
                "   XX",
                "  XXX",
                " XXX ",
                "XXX  ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.wideGuard, 1, infinityMetalId),
                "X   ",
                " X  ",
                " XX ",
                "   X",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.handGuard, 1, infinityMetalId),
                "XXX",
                "  X",
                "  X",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.crossbar, 1, infinityMetalId),
                "X  ",
                "XX ",
                " XX",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.knifeBlade, 1, infinityMetalId),
                "  XX",
                " XX ",
                "XX  ",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.frypanHead, 1, infinityMetalId),
                " XX ",
                "XXXX",
                "XXXX",
                " XX ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.signHead, 1, infinityMetalId),
                "XXXXX",
                "XXXXX",
                "XXXXX",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.chiselHead, 1, infinityMetalId),
                "    X ",
                "   XXX",
                "   XX ",
                "  X   ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.scytheBlade, 1, infinityMetalId),
                "XXXX    ",
                "  XXXX  ",
                "    XXX ",
                "     XXX",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.broadAxeHead, 1, infinityMetalId),
                "  XX",
                " XXX",
                "XXXX",
                "XXXX",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.excavatorHead, 1, infinityMetalId),
                "  X  ",
                " XXX ",
                "XXXXX",
                "XXXX ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.largeSwordBlade, 1, infinityMetalId),
                "    XXXX",
                "   XXXX ",
                "  XXXX  ",
                " XXXX   ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.hammerHead, 1, infinityMetalId),
                "  X    ",
                " XXX   ",
                "XXXXX  ",
                " XXXXX ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerWeaponry.arrowhead, 1, infinityMetalId),
                "XX  ",
                "XXXX",
                " XX ",
                " X  ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerWeaponry.partShuriken, 1, infinityMetalId),
                "  XX",
                "XXXX",
                " XX ",
                "X X ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerWeaponry.partBowLimb, 1, infinityMetalId),
                "XXXXXXX",
                'X',
                ingot);

        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerWeaponry.partCrossbowLimb, 1, infinityMetalId),
                "   XXXX",
                "  XX   ",
                " XX    ",
                "XX     ",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerWeaponry.partCrossbowBody, 1, infinityMetalId),
                "X      ",
                " XX    ",
                " XXX   ",
                "  XXX  ",
        ...
        /*
         * ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(new ItemStack(TinkerWeaponry.partBolt, 1,
         * infinityMetalId), "   X", "  X ", " X  ", "X   ", 'X', ingot);
         */

        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                new ItemStack(TinkerTools.fullGuard, 1, infinityMetalId),
                " XXX",
                "XXX ",
                "XXX ",
                " XXX",
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                getBolt(neutroniumId, infinityMetalId),
                "XX",
                "RX",
                'X',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                getBolt(infinityMetalId, infinityMetalId),
                "XX",
                "RX",
                'X',
                new ItemStack(LudicrousItems.resource, 1, 6),
