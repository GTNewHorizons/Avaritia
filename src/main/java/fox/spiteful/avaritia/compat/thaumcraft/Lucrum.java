...
public class Lucrum {
    ...
    public static void abracadabra() throws Compat.ItemNotFoundException {
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new AspectList().add(ULTRA_DEATH, 5).add(Aspect.METAL, 64).add(Aspect.ENERGY, 64)
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                new AspectList().add(ULTRA_DEATH, 60).add(Aspect.WEAPON, 999).add(Aspect.DEATH, 999)
                        .add(Aspect.ELDRITCH, 100));
        ThaumcraftApi.registerComplexObjectTag(
                new ItemStack(LudicrousItems.skull_sword),
                new AspectList().add(ULTRA_DEATH, 1).add(Aspect.FIRE, 2).add(Aspect.CRYSTAL, 16).add(Aspect.DEATH, 4));
        ...
        // ResearchCategories.registerCategory("ASCENSION", new ResourceLocation("avaritia",
        // "textures/misc/ascension.png"), new ResourceLocation("thaumcraft",
        ...
        InfusionRecipe pearl_recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                "BIG_PEARL",
                new ItemStack(LudicrousItems.bigPearl),
                12,
                (new AspectList()).add(Aspect.ELDRITCH, 64).add(Aspect.MAGIC, 64).add(Aspect.WATER, 64)
                        .add(Aspect.FIRE, 64).add(Aspect.EARTH, 64).add(Aspect.AIR, 64).add(Aspect.ORDER, 64)
                        .add(Aspect.ENTROPY, 64).add(ULTRA_DEATH, 32),
                new ItemStack(eldritch, 1, 3),
                new ItemStack[] { new ItemStack(eldritch, 1, 3), new ItemStack(eldritch, 1, 3),
                        new ItemStack(eldritch, 1, 3), new ItemStack(eldritch, 1, 3), new ItemStack(eldritch, 1, 3),
                        new ItemStack(eldritch, 1, 3), new ItemStack(eldritch, 1, 3) });
        (new LudicrousResearchItem(
                "BIG_PEARL",
                "ELDRITCH",
                (new AspectList()).add(ULTRA_DEATH, 8).add(Aspect.MAGIC, 16),
                -1,
                8,
                5,
                new ItemStack(LudicrousItems.bigPearl)))
        ...
        InfusionRecipe akashic_recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                12,
                (new AspectList()).add(Aspect.MIND, 64).add(Aspect.MAGIC, 64).add(ULTRA_DEATH, 32),
                new ItemStack(resource, 1, 9),
                new ItemStack[] { new ItemStack(LudicrousItems.resource, 1, 6),
                        new ItemStack(LudicrousItems.resource, 1, 6), new ItemStack(LudicrousItems.resource, 1, 6),
                        new ItemStack(LudicrousItems.resource, 1, 6) });
        (new LudicrousResearchItem(
                "AKASHIC",
                "ELDRITCH",
                (new AspectList()).add(ULTRA_DEATH, 8).add(Aspect.MIND, 16),
                -3,
                8,
                5,
                new ItemStack(LudicrousItems.akashic_record)))
