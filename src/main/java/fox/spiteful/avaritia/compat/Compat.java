...
public class Compat {
    ...
    public static void census() {
        ...
        // NOTE: This will only work with gt5 if you also exclude gregapi. This doesn't cause errors with gt6 now, but it might if anyone plans on using it specifically as a *gt5* check
