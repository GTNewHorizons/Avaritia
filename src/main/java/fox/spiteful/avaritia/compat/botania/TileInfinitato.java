...
public class TileInfinitato extends TileLudicrous {
    ...
    public void interact() {
        ...
        double radius = 10.5;
        int time = 3600;
        List<EntityLivingBase> inspired = this.worldObj.getEntitiesWithinAABB(
    ...
    public void jump() {
        if (jumpTicks == 0) jumpTicks = 40;
    }

    @Override
    public void updateEntity() {
        /*
         * if(worldObj.rand.nextInt(100) == 0) jump();
         */
