...
public class Achievements {
    ...
    public static void achieve() {
        crystal_matrix = new LudicrousAchievement(
                "crystal_matrix",
                0,
                0,
                new ItemStack(LudicrousItems.resource, 1, 1),
                null);
        dire_crafting = new LudicrousAchievement(
                "dire_crafting",
                1,
                1,
                new ItemStack(LudicrousBlocks.dire_crafting),
                crystal_matrix);
        collector = new LudicrousAchievement(
                "collector",
                2,
                2,
                new ItemStack(LudicrousBlocks.neutron_collector),
                dire_crafting);
        neutronium = new LudicrousAchievement(
                "neutronium",
                4,
                1,
                new ItemStack(LudicrousItems.resource, 1, 4),
                collector);
        singularity = new LudicrousAchievement(
                "singularity",
                6,
                3,
                new ItemStack(LudicrousItems.singularity, 1, 0),
                neutronium);
        catalyst = new LudicrousAchievement(
                "catalyst",
                6,
                -3,
                new ItemStack(LudicrousItems.resource, 1, 5),
                singularity).setSpecial();
        infinity = new LudicrousAchievement("infinity", 4, -6, new ItemStack(LudicrousItems.resource, 1, 6), neutronium)
                .setSpecial();
        creative_kill = new LudicrousAchievement("creative_kill", -6, -6, new ItemStack(Items.skull, 1, 3), null)
                .setSpecial();
        dire_uncrafting = new LudicrousAchievement(
                "dire_uncrafting",
                -1,
                3,
