...
public class LudicrousItems {
    ...
    /**
     * 0 = Diamond Lattice, 1 = Crystal Matrix Ingot, 2 = Pile of Neutrons, 3 = Neutronium Nugget, 4 = Neutronium Ingot,
     * 5 = Infinity Catalyst, 6 = Infinity Ingot, 7 = Record Fragment
     */
    public static Item resource;

    /**
     * 0 = Iron, 1 = Gold, 2 = Lapis, 3 = Redstone, 4 = Nether Quartz, 5 = Copper, 6 = Tin, 7 = Lead, 8 = Silver, 9 =
     * Nickel
     */
    ...
    public static void grind() {
        ...
        ultimate_stew = register(
                new ItemFood(20, 20.0f, false).setPotionEffect(Potion.regeneration.getId(), 300, 1, 1.0f)
                        .setTextureName("avaritia:stew").setUnlocalizedName("avaritia_stew")
                        .setCreativeTab(Avaritia.tab),
                "Ultimate_Stew");
        cosmic_meatballs = register(
                new ItemFood(20, 20.0f, false).setPotionEffect(Potion.damageBoost.getId(), 300, 1, 1.0f)
                        .setTextureName("avaritia:meatballs").setUnlocalizedName("avaritia_meatballs")
                        .setCreativeTab(Avaritia.tab),
                "Cosmic_Meatballs");
        ...
        if (Config.fractured) fractured_ore = register(new ItemFracturedOre(), "Fractured_Ore");
    ...
    public static boolean isInfinite(EntityPlayer player) {
        if (player.getEquipmentInSlot(1) == null || player.getEquipmentInSlot(2) == null
            ...
            return false;
        if (player.getEquipmentInSlot(1).getItem() == infinity_shoes
                && player.getEquipmentInSlot(2).getItem() == infinity_pants
                && player.getEquipmentInSlot(3).getItem() == infinity_armor
                && player.getEquipmentInSlot(4).getItem() == infinity_helm)
            return true;
        else return false;
    }
